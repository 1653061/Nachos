...
int 
AddrSpace::Translate(int virtAddr) // chuyen doi virt addr sang physical addr
{
	int physAddr;
...
// first, set up the translation 
	...
	pageTable[i].physicalPage = gPhysPageBitMap->Find(); // tim trang trong sau do nap len bo nho chinh
	...
	bzero(&machine->mainMemory[pageTable[i].physicalPage*PageSize],PageSize); // nap moi chuong trinh vao bo nho
    }
